...
func initial_value_slider():
	carga.value = object.char
	x.value =object.info[0]
	y.value = object.info[1]
	z.value = object.info[2]
	w.value = object.info[3]
...
func _on_carga_value_changed(value):
	...
	if object!= null:
		object.char = carga.value

func _on_x_value_changed(value):
	x.label_2.text = str(value)
	if object!= null:
		object.info[0] = x.value

func _on_y_value_changed(value):
	y.label_2.text = str(value)
	if object!= null:
		if object.type == 1:
			object.info[1] = deg_to_rad(y.value)
		else :
			object.info[1] = y.value

func _on_z_value_changed(value):
	z.label_2.text = str(value)
	if object!= null:
		object.info[2] = z.value

func _on_w_value_changed(value):
	w.label_2.text = str(value)
	if object!= null:
		if object.type == 4:
			object.info[3] =deg_to_rad(w.value)
		else:
			object.info[3] = w.value
